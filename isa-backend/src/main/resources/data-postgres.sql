...
values('D','Marko','Markovic','doktor@gmail.com','$2y$10$6/ExZPzokaxKh91XVMiSNOm/gsVJe8YkkXL.Kj3jivRJpGzagVnia','dr ribara 1','ACTIVE','8am','4pm',1,true);

insert into person(type,first_name,last_name,username,password,address,status,jmbg,enabled)
values('P','Jovan','Peric','pacijent@gmail.com','$2y$10$6/ExZPzokaxKh91XVMiSNOm/gsVJe8YkkXL.Kj3jivRJpGzagVnia','dr ribara 1','ACTIVE','0203998800022',true);

insert into person(type,first_name,last_name,username,password,address,status,jmbg,enabled)
values('P','test','test','pacijent2@gmail.com','$2y$10$6/ExZPzokaxKh91XVMiSNOm/gsVJe8YkkXL.Kj3jivRJpGzagVnia','dr ribara 1','PENDING','02039988000223',true);

insert into person(type,first_name,last_name,username,password,address,status,worktime_start,worktime_end,clinic_id,enabled)
values('N','Stefan','Stefanovic','sestra1@gmail.com','$2y$10$6/ExZPzokaxKh91XVMiSNOm/gsVJe8YkkXL.Kj3jivRJpGzagVnia','dr ribara 1','ACTIVE','8am','4pm',1,true);

insert into person(type,first_name,last_name,username,password,address,status,enabled,clinic_id)
values('A','Dragan','Draganovic','admin1@gmail.com','$2y$10$6/ExZPzokaxKh91XVMiSNOm/gsVJe8YkkXL.Kj3jivRJpGzagVnia','dr ribara 1','ACTIVE',true,1);

insert into person(type,first_name,last_name,username,password,address,status,enabled)
values('CCA','Nikola','Nikolc','ccadmin@gmail.com','$2y$10$6/ExZPzokaxKh91XVMiSNOm/gsVJe8YkkXL.Kj3jivRJpGzagVnia','dr ribara 1','ACTIVE',true);
...
insert into appointment(date,discount,price,status,type,doctor_id,room_id) values ('2020-03-02 15:00:00.000',12,0,'','Pedijatar',2,1);
insert into appointment(date,discount,price,status,type,doctor_id,room_id) values ('2020-02-02 16:00:00.000',12,0,'','Pedijatar',2,1);
insert into appointment(date,discount,price,status,type,doctor_id,room_id) values ('2020-02-02 19:00:00.000',12,0,'','Pedijatar',2,1);
