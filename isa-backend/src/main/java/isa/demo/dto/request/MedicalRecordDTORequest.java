...
public class MedicalRecordDTORequest {
    ...
    public MedicalRecordDTORequest(Long id, Double height, Double weight, Double diopter, String alergies, String bloodType,String firstName,String lastName,String jmbg) {
        this.id = id;
        this.height = height;
        this.weight = weight;
    ...
    public MedicalRecordDTORequest(MedicalRecord record, Patient p){
    ...
    public MedicalRecordDTORequest() {
